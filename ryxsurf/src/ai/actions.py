...
class BrowserActions:
    ...
    def get_page_title() -> str:
        """Get the page title"""
        return "document.title; JSON.stringify({result: 'success'})"

    @staticmethod
    def refresh() -> str:
        """Refresh the page"""
        return "location.reload(); JSON.stringify({result: 'success'})"
        ...
        (function() {
            ...
            if (selection) {
                navigator.clipboard.writeText(selection).then(() => {
                    return JSON.stringify({result: 'success', message: 'Copied to clipboard'});
                }).catch(err => {
                    return JSON.stringify({result: 'error', message: 'Failed to copy: ' + err});
                });
            } else {
                return JSON.stringify({result: 'not_found', message: 'No text selected'});
            }
        })()
        """
    ...
    def select_all() -> str:
        ...
        (function() {
            ...
            return JSON.stringify({result: 'success', message: 'All text selected'});
        })()
        """
    ...
    def clear_selection() -> str:
        ...
        (function() {
            const selection = window.getSelection();
            selection.removeAllRanges();
            return JSON.stringify({result: 'success', message: 'Selection cleared'});
        })()
        """
    ...
    @staticmethod
    def stop_loading() -> str:
        """Stop loading the page"""
        return "window.stop(); JSON.stringify({result: 'success'})"
    ...
    def get_images() -> str:
        ...
        (function() {
            ...
            return JSON.stringify({result: 'success', data: sources});
        })()
        """
...
def print_page() -> str:
    ...
    (function() {
        window.print();
        return JSON.stringify({result: 'success', message: 'Page print initiated'});
    })()
    """
    ...
    def blur_active() -> str:
        ...
        return "document.activeElement?.blur(); JSON.stringify({result: 'success'})"
    ...
    def get_meta_tags() -> str:
        ...
        (function() {
            ...
            return JSON.stringify({result: 'success', data: metas});
        })()
        """
